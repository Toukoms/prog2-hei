public class App {
  public static void main(String[] args) {
    ...
    Appartement apart1 = new Appartement("1", "Apart 1", "Description 1", 528, Status.FREE);
    Appartement apart2 = new Appartement("2", "Apart 2", "Description 2", 436, Status.OWNED);
    Appartement apart3 = new Appartement("3", "Apart 3", "Description 3", 631, Status.IN_PROCESS);
    Appartement apart4 = new Appartement("4", "Apart 4", "Description 4", 389, Status.OWNED);
